...
public class CodingScheme {
	public attributenetwork an;
	public int numVertices;
	public int numFeature;
	public int [][] AdjNode;
	public int [][] AdjFeature;
	
	public double ccClusterStructure;
	public double ccClusterFeature;
	public double ccUnClusterStructure;
	public double ccUnClusterFeature;
